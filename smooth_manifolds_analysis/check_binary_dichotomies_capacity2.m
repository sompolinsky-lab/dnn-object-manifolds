function [Nc, separablity_results, Ns, n_neuron_samples_used, n_support_vectors] = check_binary_dichotomies_capacity2(...
    XsAll, EXPECTED_PRECISION, verbose, random_labeling_type, precision, max_samples, global_preprocessing, features_type, jumps)
...
% to minimize computational cost.
    ...
    for n=J
        ...
        if isnan(separablity_results(n))
            [separability, nsv_per_object] = check_binary_dichotomies_sampled_features2(XsAll, n, EXPECTED_PRECISION, ...
                random_labeling_type, max_samples, global_preprocessing, verbose>1, features_type);
